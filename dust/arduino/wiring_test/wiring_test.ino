/*
   ...
   Arduino Uno or Nano and ILI9844 3.5in TFT screen and servo pins. Use it
   without the actual display being plugged into the breadboard.
   ...
   Arduino ports are corrected to the right LCS pins, as well as if the servo
   pins are connected properly.

   Based on touchscreen wiring_test with seven servo pins added.
